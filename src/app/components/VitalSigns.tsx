...
export function VitalSigns() {
  const { addToQueue } = usePatientQueue();
  const { vitalSignsQueue, isLoading, updatePatientVitalSigns, updatePatientInjection, updatePatientStatus } = useVitalSigns();
  ...
  // Available Doctors
  const doctors = [
    { id: 'DR001', name: 'Dr. Sarah Johnson', department: 'Cardiology', room: 'CR-101', specialty: 'Cardiologist' },
    { id: 'DR002', name: 'Dr. Michael Chen', department: 'Orthopedics', room: 'CR-205', specialty: 'Orthopedic Surgeon' },
    { id: 'DR003', name: 'Dr. Amina Yusuf', department: 'Pediatrics', room: 'CR-103', specialty: 'Pediatrician' },
    { id: 'DR004', name: 'Dr. James Anderson', department: 'General Surgery', room: 'CR-301', specialty: 'Surgeon' },
    { id: 'DR005', name: 'Dr. Fatima Ibrahim', department: 'Obstetrics & Gynecology', room: 'CR-202', specialty: 'OB/GYN' },
    { id: 'DR006', name: 'Dr. David Williams', department: 'Neurology', room: 'CR-104', specialty: 'Neurologist' },
    { id: 'DR007', name: 'Dr. Ahmed Hassan', department: 'Internal Medicine', room: 'CR-106', specialty: 'Internist' },
    { id: 'DR008', name: 'Dr. Grace Nnenna', department: 'Dermatology', room: 'CR-207', specialty: 'Dermatologist' },
  ];
  ...
  const handleSaveVitalSigns = () => {
    ...
    updatePatientVitalSigns(selectedPatient.patientId, updatedVitalSigns);
  ...
  const handleOpenRouteDialog = () => {
    ...
    if (initialDoctor) {
      ...
      setSelectedDepartment(initialDoctor.department);
      setConsultingRoom(initialDoctor.room);
    }
  ...
  const handleRouteToDoctor = () => {
    ...
    // Add patient to doctor's queue via context
    addToQueue({
      id: selectedPatient.id,
      patientId: selectedPatient.patientId,
      patientName: selectedPatient.patientName,
      cardNumber: selectedPatient.patientId,
      ...
      vitalSigns: {
        bp: selectedPatient.vitalSigns.bloodPressure,
        temp: selectedPatient.vitalSigns.temperature,
        pulse: selectedPatient.vitalSigns.pulse,
        weight: selectedPatient.vitalSigns.weight,
        height: selectedPatient.vitalSigns.height,
        bmi: selectedPatient.vitalSigns.bmi,
        respiratoryRate: selectedPatient.vitalSigns.respiratoryRate,
        oxygenSaturation: selectedPatient.vitalSigns.oxygenSaturation,
        bloodSugar: selectedPatient.vitalSigns.bloodSugar,
        notes: selectedPatient.vitalSigns.notes,
      },
      injectionRecord: selectedPatient.injectionRecord ? {
        medicationName: selectedPatient.injectionRecord.medicationName,
        dosage: selectedPatient.injectionRecord.dosage,
        route: selectedPatient.injectionRecord.routeToDoctor,
        site: selectedPatient.injectionRecord.injectionSite,
        batchNumber: selectedPatient.injectionRecord.batchNumber,
        notes: selectedPatient.injectionRecord.notes,
      } : undefined,
    });
    ...
    updatePatientStatus(selectedPatient.patientId, 'sent-to-doctor');
