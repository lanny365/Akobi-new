...
export function Root() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-sky-50 to-cyan-100">
      <header className="relative z-50 border-b border-blue-800/35 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-700 backdrop-blur-xl shadow-xl shadow-blue-900/20">
