...
export function Pharmacy() {
  ...
  const { generalLedgerAccounts } = useCashier();
  ...
  const generalLedgerSearchOptions = useMemo(
    () =>
      generalLedgerAccounts
        .map((account) => ({
          value: `${account.code} - ${account.accountDetail}`,
          label: `${account.code} - ${account.accountDetail}`,
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <SearchableSelect
                  ...
                  onValueChange={(value) => setNewProduct({ ...newProduct, accountToCredit: value })}
                  options={generalLedgerSearchOptions}
              ...
              <div>
                ...
                <SearchableSelect
                  ...
                  onValueChange={(value) => setNewProduct({ ...newProduct, accountToDebit: value })}
                  options={generalLedgerSearchOptions}
