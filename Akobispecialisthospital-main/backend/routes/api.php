...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::put('/visits/{visit}/vital-signs', [VisitController::class, 'recordVitalSigns']);
    Route::put('/visits/{visit}/route-to-doctor', [VisitController::class, 'routeToDoctor']);
    Route::get('/queue/vital-signs', [VisitController::class, 'vitalSignsQueue']);
    Route::get('/queue/doctors', [VisitController::class, 'doctorQueue']);
